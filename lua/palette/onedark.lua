...
F.get_palette = function() return F.palette end

--- Get highlights depending on OneDarkPalette
---@param theme OneDarkPalette
---@return table<string, vim.api.keyset.highlight>
function F.build_themed_highlights(theme)
  local c = theme
  ...
  hl.common = {
    ...
    DiffDelete = { fg = "none", bg = c.diff_delete },
    ...
    MatchParen = { fg = "none", bg = c.grey },
    NonText = { fg = c.grey },
    Whitespace = { fg = c.grey },
    SpecialKey = { fg = c.grey },
    Pmenu = { fg = c.fg, bg = c.bg1 },
    PmenuSbar = { fg = "none", bg = c.bg1 },
    ...
    Visual = { bg = c.bg3 },
    VisualNOS = { fg = "none", bg = c.bg2, underline = true },
  ...
  hl.treesitter = {
    ...
    ["@constructor.lua"] = { fg = c.light_grey },
    ...
    ["@function.call"] = F.extend({ fg = c.blue }, code_style.functions),
    ["@function.macro"] = F.extend({ fg = c.cyan }, code_style.functions),
    ["@function.method"] = F.extend({ fg = c.blue }, code_style.functions),
    ["@function.method.call"] = F.extend({ fg = c.blue }, code_style.functions),
    ["@keyword"] = F.extend({ fg = c.purple }, code_style.keywords),
  ...
  hl.diagnostic = {
    ...
    DiagnosticVirtualTextError = { bg = "none", fg = c.dark_red },
    DiagnosticVirtualTextWarn = { bg = "none", fg = c.dark_yellow },
    DiagnosticVirtualTextInfo = { bg = "none", fg = c.dark_cyan },
    DiagnosticVirtualTextHint = { bg = "none", fg = c.dark_purple },
...
--- Get OneDark highlights
---@return table<string, vim.api.keyset.highlight>
function F.build_highlights() return F.build_themed_highlights(F.palette) end
...
return {
  ...
  build_themed_highlights = F.build_themed_highlights,
}
